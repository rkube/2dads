...
int main(void){
    ...
    twodads::slab_layout_t my_geom(-10.0, 20.0 / double(Nx), -10.0, 20.0 / double(My), Nx, 0, My, 2, twodads::grid_t::cell_centered);
