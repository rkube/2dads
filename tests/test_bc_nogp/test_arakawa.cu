...
int main(void){
...

    {
        ...
        //sol_num.copy_device_to_host();
        fname.str(string(""));
        fname << "test_arakawa_arr4_" << Nx << "_out.dat";
        ofstream of(fname.str());
        of << sol_num;
        of.close();
        ...
        //sol_num.copy_device_to_host();
        fname.str(string(""));
        fname << "test_arakawa_arr5_" << Nx << "_out.dat";
        of.open(fname.str());
        of << sol_num;
        of.close();
        //cout << "Nx = " << Nx << ", My = " << My << ", L2 = " << sol_num - sol_an << endl;
    }
    cudaDeviceReset();
}
