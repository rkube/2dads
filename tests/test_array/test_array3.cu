...
int main(void)
{
    ...
    cuda_array<double, double> r_arr1(tlevs, My, Nx);
    cuda_array<double, double> r_arr2(tlevs, My, Nx);
    cuda_array<CuCmplx<double>, double> c_arr1(tlevs, My, Nx);
    cuda_array<CuCmplx<double>, double> c_arr2(tlevs, My, Nx);
