...
int main(void)
{
    ...
    cout << "omega=\n";
    slab.print_field(twodads::field_t::f_omega);
    cout << "omega_x=\n";
    slab.print_field(twodads::field_t::f_omega_x);
    cout << "omega_y=\n";
    slab.print_field(twodads::field_t::f_omega_y);
    cout << "strmf=\n";
    slab.print_field(twodads::field_t::f_strmf);
    cout << "strmf_x=\n";
    slab.print_field(twodads::field_t::f_strmf_x);
    cout << "strmf_y=\n";
